...
*   [Introduction to Lipgloss](https://deepwiki.com/charmbracelet/lipgloss#introduction-to-lipgloss)
    
*   [Purpose and Scope](https://deepwiki.com/charmbracelet/lipgloss#purpose-and-scope)
    
*   [What is Lipgloss](https://deepwiki.com/charmbracelet/lipgloss#what-is-lipgloss)
    
*   [Installation and Module Structure](https://deepwiki.com/charmbracelet/lipgloss#installation-and-module-structure)
    
*   [Go Module Information](https://deepwiki.com/charmbracelet/lipgloss#go-module-information)
    
*   [Dependencies](https://deepwiki.com/charmbracelet/lipgloss#dependencies)
    
*   [Package Structure](https://deepwiki.com/charmbracelet/lipgloss#package-structure)
    
*   [Core Architecture Overview](https://deepwiki.com/charmbracelet/lipgloss#core-architecture-overview)
    
*   [System Organization](https://deepwiki.com/charmbracelet/lipgloss#system-organization)
    
*   [Style System Foundation](https://deepwiki.com/charmbracelet/lipgloss#style-system-foundation)
    
*   [Core Rendering Pipeline](https://deepwiki.com/charmbracelet/lipgloss#core-rendering-pipeline)
    
*   [Key Code Entities Reference](https://deepwiki.com/charmbracelet/lipgloss#key-code-entities-reference)
    
*   [Basic Usage Pattern](https://deepwiki.com/charmbracelet/lipgloss#basic-usage-pattern)
    
*   [Color System and Terminal Adaptation](https://deepwiki.com/charmbracelet/lipgloss#color-system-and-terminal-adaptation)
    
*   [Color Profiles and Detection](https://deepwiki.com/charmbracelet/lipgloss#color-profiles-and-detection)
    
*   [Adaptive Color Functions](https://deepwiki.com/charmbracelet/lipgloss#adaptive-color-functions)
    
*   [Component Ecosystem](https://deepwiki.com/charmbracelet/lipgloss#component-ecosystem)
