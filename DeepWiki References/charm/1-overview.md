...
*   [Overview](https://deepwiki.com/charmbracelet/charm/1-overview#overview)
    
*   [Core Components](https://deepwiki.com/charmbracelet/charm/1-overview#core-components)
    
*   [Component Relationship Diagram](https://deepwiki.com/charmbracelet/charm/1-overview#component-relationship-diagram)
    
*   [Client-Server Architecture](https://deepwiki.com/charmbracelet/charm/1-overview#client-server-architecture)
    
*   [Architecture Diagram](https://deepwiki.com/charmbracelet/charm/1-overview#architecture-diagram)
    
*   [Data Flow](https://deepwiki.com/charmbracelet/charm/1-overview#data-flow)
    
*   [Data Flow Diagram](https://deepwiki.com/charmbracelet/charm/1-overview#data-flow-diagram)
    
*   [Authentication System](https://deepwiki.com/charmbracelet/charm/1-overview#authentication-system)
    
*   [Authentication Flow](https://deepwiki.com/charmbracelet/charm/1-overview#authentication-flow)
    
*   [Encryption System](https://deepwiki.com/charmbracelet/charm/1-overview#encryption-system)
    
*   [Encryption Flow](https://deepwiki.com/charmbracelet/charm/1-overview#encryption-flow)
    
*   [Server Implementation](https://deepwiki.com/charmbracelet/charm/1-overview#server-implementation)
    
*   [Server Components](https://deepwiki.com/charmbracelet/charm/1-overview#server-components)
    
*   [Configuration](https://deepwiki.com/charmbracelet/charm/1-overview#configuration)
    
*   [Client Configuration](https://deepwiki.com/charmbracelet/charm/1-overview#client-configuration)
    
*   [Server Configuration](https://deepwiki.com/charmbracelet/charm/1-overview#server-configuration)
    
*   [Deployment Options](https://deepwiki.com/charmbracelet/charm/1-overview#deployment-options)
    
*   [Storage Considerations](https://deepwiki.com/charmbracelet/charm/1-overview#storage-considerations)
    
*   [Using the Charm CLI](https://deepwiki.com/charmbracelet/charm/1-overview#using-the-charm-cli)
