...
*   [Overview](https://deepwiki.com/charmbracelet/bubbletea#overview)
    
*   [What is Bubble Tea?](https://deepwiki.com/charmbracelet/bubbletea#what-is-bubble-tea)
    
*   [Core Architecture](https://deepwiki.com/charmbracelet/bubbletea#core-architecture)
    
*   [The Elm Architecture Pattern](https://deepwiki.com/charmbracelet/bubbletea#the-elm-architecture-pattern)
    
*   [Program Flow Diagram](https://deepwiki.com/charmbracelet/bubbletea#program-flow-diagram)
    
*   [Core Types](https://deepwiki.com/charmbracelet/bubbletea#core-types)
    
*   [Repository Structure](https://deepwiki.com/charmbracelet/bubbletea#repository-structure)
    
*   [Directory Layout](https://deepwiki.com/charmbracelet/bubbletea#directory-layout)
    
*   [Module Dependencies](https://deepwiki.com/charmbracelet/bubbletea#module-dependencies)
    
*   [Charmbracelet Ecosystem](https://deepwiki.com/charmbracelet/bubbletea#charmbracelet-ecosystem)
    
*   [Key Dependencies](https://deepwiki.com/charmbracelet/bubbletea#key-dependencies)
    
*   [Program Lifecycle](https://deepwiki.com/charmbracelet/bubbletea#program-lifecycle)
    
*   [Execution Stages](https://deepwiki.com/charmbracelet/bubbletea#execution-stages)
    
*   [Goroutines Created](https://deepwiki.com/charmbracelet/bubbletea#goroutines-created)
    
*   [Quick Start Example](https://deepwiki.com/charmbracelet/bubbletea#quick-start-example)
    
*   [Program Options](https://deepwiki.com/charmbracelet/bubbletea#program-options)
    
*   [Message Types](https://deepwiki.com/charmbracelet/bubbletea#message-types)
    
*   [System Messages](https://deepwiki.com/charmbracelet/bubbletea#system-messages)
    
*   [Input Messages](https://deepwiki.com/charmbracelet/bubbletea#input-messages)
    
*   [Configuration Messages](https://deepwiki.com/charmbracelet/bubbletea#configuration-messages)
    
*   [View Structure](https://deepwiki.com/charmbracelet/bubbletea#view-structure)
    
*   [Next Steps](https://deepwiki.com/charmbracelet/bubbletea#next-steps)
