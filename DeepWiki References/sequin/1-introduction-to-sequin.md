...
*   [Introduction to Sequin](https://deepwiki.com/charmbracelet/sequin/1-introduction-to-sequin#introduction-to-sequin)
    
*   [Purpose and Key Features](https://deepwiki.com/charmbracelet/sequin/1-introduction-to-sequin#purpose-and-key-features)
    
*   [System Architecture](https://deepwiki.com/charmbracelet/sequin/1-introduction-to-sequin#system-architecture)
    
*   [Core Components and Workflow](https://deepwiki.com/charmbracelet/sequin/1-introduction-to-sequin#core-components-and-workflow)
    
*   [ANSI Sequence Handling](https://deepwiki.com/charmbracelet/sequin/1-introduction-to-sequin#ansi-sequence-handling)
    
*   [Input Processing](https://deepwiki.com/charmbracelet/sequin/1-introduction-to-sequin#input-processing)
    
*   [Theming System](https://deepwiki.com/charmbracelet/sequin/1-introduction-to-sequin#theming-system)
    
*   [Raw Mode](https://deepwiki.com/charmbracelet/sequin/1-introduction-to-sequin#raw-mode)
    
*   [Control Code Handling](https://deepwiki.com/charmbracelet/sequin/1-introduction-to-sequin#control-code-handling)
    
*   [Summary](https://deepwiki.com/charmbracelet/sequin/1-introduction-to-sequin#summary)
