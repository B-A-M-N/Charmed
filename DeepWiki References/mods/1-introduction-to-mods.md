...
*   [Introduction to Mods](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#introduction-to-mods)
    
*   [Purpose and Scope](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#purpose-and-scope)
    
*   [What is Mods](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#what-is-mods)
    
*   [System Architecture Overview](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#system-architecture-overview)
    
*   [User Interaction Flow](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#user-interaction-flow)
    
*   [Core Components](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#core-components)
    
*   [CLI and Configuration](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#cli-and-configuration)
    
*   [Terminal User Interface](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#terminal-user-interface)
    
*   [LLM Integration](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#llm-integration)
    
*   [Data Management](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#data-management)
    
*   [External Tool Integration](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#external-tool-integration)
    
*   [Key Design Principles](https://deepwiki.com/charmbracelet/mods/1-introduction-to-mods#key-design-principles)
