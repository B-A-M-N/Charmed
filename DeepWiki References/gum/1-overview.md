...
*   [Overview](https://deepwiki.com/charmbracelet/gum/1-overview#overview)
    
*   [Purpose and Design Philosophy](https://deepwiki.com/charmbracelet/gum/1-overview#purpose-and-design-philosophy)
    
*   [System Architecture](https://deepwiki.com/charmbracelet/gum/1-overview#system-architecture)
    
*   [Layered Architecture](https://deepwiki.com/charmbracelet/gum/1-overview#layered-architecture)
    
*   [Command Structure Pattern](https://deepwiki.com/charmbracelet/gum/1-overview#command-structure-pattern)
    
*   [Command Execution Patterns](https://deepwiki.com/charmbracelet/gum/1-overview#command-execution-patterns)
    
*   [Command Categories](https://deepwiki.com/charmbracelet/gum/1-overview#command-categories)
    
*   [Interactive Selection Commands](https://deepwiki.com/charmbracelet/gum/1-overview#interactive-selection-commands)
    
*   [Input Commands](https://deepwiki.com/charmbracelet/gum/1-overview#input-commands)
    
*   [Formatting and Display Commands](https://deepwiki.com/charmbracelet/gum/1-overview#formatting-and-display-commands)
    
*   [Data Flow and I/O Patterns](https://deepwiki.com/charmbracelet/gum/1-overview#data-flow-and-io-patterns)
    
*   [Key Dependencies](https://deepwiki.com/charmbracelet/gum/1-overview#key-dependencies)
