...
*   [Overview](https://deepwiki.com/charmbracelet/harmonica/1-overview#overview)
    
*   [Purpose and Scope](https://deepwiki.com/charmbracelet/harmonica/1-overview#purpose-and-scope)
    
*   [Architecture Overview](https://deepwiki.com/charmbracelet/harmonica/1-overview#architecture-overview)
    
*   [High-Level Structure](https://deepwiki.com/charmbracelet/harmonica/1-overview#high-level-structure)
    
*   [Core Components Relationship](https://deepwiki.com/charmbracelet/harmonica/1-overview#core-components-relationship)
    
*   [Spring System](https://deepwiki.com/charmbracelet/harmonica/1-overview#spring-system)
    
*   [Spring Configuration](https://deepwiki.com/charmbracelet/harmonica/1-overview#spring-configuration)
    
*   [Damping Behavior](https://deepwiki.com/charmbracelet/harmonica/1-overview#damping-behavior)
    
*   [Projectile Motion](https://deepwiki.com/charmbracelet/harmonica/1-overview#projectile-motion)
    
*   [Projectile Components](https://deepwiki.com/charmbracelet/harmonica/1-overview#projectile-components)
    
*   [Animation Flow](https://deepwiki.com/charmbracelet/harmonica/1-overview#animation-flow)
    
*   [Spring Animation Data Flow](https://deepwiki.com/charmbracelet/harmonica/1-overview#spring-animation-data-flow)
    
*   [Projectile Motion Data Flow](https://deepwiki.com/charmbracelet/harmonica/1-overview#projectile-motion-data-flow)
    
*   [Integration with Applications](https://deepwiki.com/charmbracelet/harmonica/1-overview#integration-with-applications)
    
*   [Summary](https://deepwiki.com/charmbracelet/harmonica/1-overview#summary)
