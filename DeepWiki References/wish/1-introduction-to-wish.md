...
*   [Introduction to Wish](https://deepwiki.com/charmbracelet/wish/1-introduction-to-wish#introduction-to-wish)
    
*   [What is Wish?](https://deepwiki.com/charmbracelet/wish/1-introduction-to-wish#what-is-wish)
    
*   [Why SSH Applications?](https://deepwiki.com/charmbracelet/wish/1-introduction-to-wish#why-ssh-applications)
    
*   [Core Architecture](https://deepwiki.com/charmbracelet/wish/1-introduction-to-wish#core-architecture)
    
*   [Middleware System](https://deepwiki.com/charmbracelet/wish/1-introduction-to-wish#middleware-system)
    
*   [Key Middleware Components](https://deepwiki.com/charmbracelet/wish/1-introduction-to-wish#key-middleware-components)
    
*   [Basic Server Example](https://deepwiki.com/charmbracelet/wish/1-introduction-to-wish#basic-server-example)
    
*   [Server Configuration Options](https://deepwiki.com/charmbracelet/wish/1-introduction-to-wish#server-configuration-options)
    
*   [Applications Built with Wish](https://deepwiki.com/charmbracelet/wish/1-introduction-to-wish#applications-built-with-wish)
    
*   [Conclusion](https://deepwiki.com/charmbracelet/wish/1-introduction-to-wish#conclusion)
