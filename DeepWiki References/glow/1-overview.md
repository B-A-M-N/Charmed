...
*   [Overview](https://deepwiki.com/charmbracelet/glow/1-overview#overview)
    
*   [Purpose and Scope](https://deepwiki.com/charmbracelet/glow/1-overview#purpose-and-scope)
    
*   [What is Glow](https://deepwiki.com/charmbracelet/glow/1-overview#what-is-glow)
    
*   [Application Entry Point](https://deepwiki.com/charmbracelet/glow/1-overview#application-entry-point)
    
*   [Dual-Mode Architecture](https://deepwiki.com/charmbracelet/glow/1-overview#dual-mode-architecture)
    
*   [Core Components and Data Flow](https://deepwiki.com/charmbracelet/glow/1-overview#core-components-and-data-flow)
    
*   [Configuration System](https://deepwiki.com/charmbracelet/glow/1-overview#configuration-system)
    
*   [Source Resolution Pipeline](https://deepwiki.com/charmbracelet/glow/1-overview#source-resolution-pipeline)
    
*   [Key Dependencies](https://deepwiki.com/charmbracelet/glow/1-overview#key-dependencies)
