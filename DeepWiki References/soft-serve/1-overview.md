...
*   [Overview](https://deepwiki.com/charmbracelet/soft-serve/1-overview#overview)
    
*   [What is Soft Serve?](https://deepwiki.com/charmbracelet/soft-serve/1-overview#what-is-soft-serve)
    
*   [System Architecture](https://deepwiki.com/charmbracelet/soft-serve/1-overview#system-architecture)
    
*   [Configuration System](https://deepwiki.com/charmbracelet/soft-serve/1-overview#configuration-system)
    
*   [Core Configuration Elements](https://deepwiki.com/charmbracelet/soft-serve/1-overview#core-configuration-elements)
    
*   [Authentication and Authorization](https://deepwiki.com/charmbracelet/soft-serve/1-overview#authentication-and-authorization)
    
*   [Repository Management](https://deepwiki.com/charmbracelet/soft-serve/1-overview#repository-management)
    
*   [Terminal User Interface](https://deepwiki.com/charmbracelet/soft-serve/1-overview#terminal-user-interface)
    
*   [User Interaction Flows](https://deepwiki.com/charmbracelet/soft-serve/1-overview#user-interaction-flows)
    
*   [Extending Soft Serve](https://deepwiki.com/charmbracelet/soft-serve/1-overview#extending-soft-serve)
    
*   [Summary](https://deepwiki.com/charmbracelet/soft-serve/1-overview#summary)
