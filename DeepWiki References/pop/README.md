...
*   [Overview](https://deepwiki.com/charmbracelet/pop#overview)
    
*   [Core Features](https://deepwiki.com/charmbracelet/pop#core-features)
    
*   [System Architecture Overview](https://deepwiki.com/charmbracelet/pop#system-architecture-overview)
    
*   [Command Line Interface](https://deepwiki.com/charmbracelet/pop#command-line-interface)
    
*   [Terminal User Interface](https://deepwiki.com/charmbracelet/pop#terminal-user-interface)
    
*   [Delivery Methods](https://deepwiki.com/charmbracelet/pop#delivery-methods)
    
*   [1\. Resend API](https://deepwiki.com/charmbracelet/pop#1-resend-api)
    
*   [2\. SMTP](https://deepwiki.com/charmbracelet/pop#2-smtp)
    
*   [Configuration Options](https://deepwiki.com/charmbracelet/pop#configuration-options)
    
*   [Integration Examples](https://deepwiki.com/charmbracelet/pop#integration-examples)
    
*   [License](https://deepwiki.com/charmbracelet/pop#license)
