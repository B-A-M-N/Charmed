...
*   [Introduction to Wishlist](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#introduction-to-wishlist)
    
*   [Purpose and Key Features](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#purpose-and-key-features)
    
*   [System Overview](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#system-overview)
    
*   [Operation Modes](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#operation-modes)
    
*   [Local Mode](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#local-mode)
    
*   [Server Mode](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#server-mode)
    
*   [Data Flow](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#data-flow)
    
*   [Configuration System](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#configuration-system)
    
*   [Component Architecture](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#component-architecture)
    
*   [Authentication Methods](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#authentication-methods)
    
*   [Local Mode Authentication](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#local-mode-authentication)
    
*   [Server Mode Authentication](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#server-mode-authentication)
    
*   [Discovery Methods](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#discovery-methods)
    
*   [Tailscale Integration](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#tailscale-integration)
    
*   [Zeroconf/mDNS](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#zeroconfmdns)
    
*   [SRV Records](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#srv-records)
    
*   [Summary](https://deepwiki.com/charmbracelet/wishlist/1-introduction-to-wishlist#summary)
