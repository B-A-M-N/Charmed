...
*   [Overview](https://deepwiki.com/charmbracelet/fang#overview)
    
*   [Purpose and Scope](https://deepwiki.com/charmbracelet/fang#purpose-and-scope)
    
*   [Architecture Overview](https://deepwiki.com/charmbracelet/fang#architecture-overview)
    
*   [Core Components and Code Mapping](https://deepwiki.com/charmbracelet/fang#core-components-and-code-mapping)
    
*   [Execution Entry Point](https://deepwiki.com/charmbracelet/fang#execution-entry-point)
    
*   [Help Rendering System](https://deepwiki.com/charmbracelet/fang#help-rendering-system)
    
*   [Theme and Styling Engine](https://deepwiki.com/charmbracelet/fang#theme-and-styling-engine)
    
*   [Error Handling](https://deepwiki.com/charmbracelet/fang#error-handling)
    
*   [Execution Lifecycle](https://deepwiki.com/charmbracelet/fang#execution-lifecycle)
    
*   [Feature Integration Points](https://deepwiki.com/charmbracelet/fang#feature-integration-points)
    
*   [Version Management](https://deepwiki.com/charmbracelet/fang#version-management)
    
*   [Manpage Generation](https://deepwiki.com/charmbracelet/fang#manpage-generation)
    
*   [Shell Completions](https://deepwiki.com/charmbracelet/fang#shell-completions)
    
*   [Signal Handling](https://deepwiki.com/charmbracelet/fang#signal-handling)
    
*   [Dependency Overview](https://deepwiki.com/charmbracelet/fang#dependency-overview)
    
*   [Testing Strategy](https://deepwiki.com/charmbracelet/fang#testing-strategy)
