...
*   [Overview](https://deepwiki.com/charmbracelet/glamour/1-overview#overview)
    
*   [What Glamour Does](https://deepwiki.com/charmbracelet/glamour/1-overview#what-glamour-does)
    
*   [Core Architecture Layers](https://deepwiki.com/charmbracelet/glamour/1-overview#core-architecture-layers)
    
*   [Markdown Processing Pipeline](https://deepwiki.com/charmbracelet/glamour/1-overview#markdown-processing-pipeline)
    
*   [Key Component Mapping](https://deepwiki.com/charmbracelet/glamour/1-overview#key-component-mapping)
    
*   [Primary Types](https://deepwiki.com/charmbracelet/glamour/1-overview#primary-types)
    
*   [Main Entry Points](https://deepwiki.com/charmbracelet/glamour/1-overview#main-entry-points)
    
*   [Rendering Lifecycle](https://deepwiki.com/charmbracelet/glamour/1-overview#rendering-lifecycle)
    
*   [External Dependencies](https://deepwiki.com/charmbracelet/glamour/1-overview#external-dependencies)
    
*   [Style System Overview](https://deepwiki.com/charmbracelet/glamour/1-overview#style-system-overview)
    
*   [Usage Patterns](https://deepwiki.com/charmbracelet/glamour/1-overview#usage-patterns)
    
*   [Simple Rendering](https://deepwiki.com/charmbracelet/glamour/1-overview#simple-rendering)
    
*   [Custom Configuration](https://deepwiki.com/charmbracelet/glamour/1-overview#custom-configuration)
    
*   [Next Steps](https://deepwiki.com/charmbracelet/glamour/1-overview#next-steps)
